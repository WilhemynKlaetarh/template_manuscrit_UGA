...
% Width parameters
\setlength{\oddsidemargin}{2cm} %Valeur des marges pages impaires mettre 4cm
\setlength{\evensidemargin}{2cm} %Valeur des marges pages paires mettre 2cm
\setlength{\textwidth}{17cm} %Largeur du texte 15cm il reste donc 6cm pour les marges droite et gauches
